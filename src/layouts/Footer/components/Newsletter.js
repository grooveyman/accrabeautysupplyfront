        ...
        <div className="flex flex-col sm:flex-row w-full gap-x-3">
          <div className="w-full sm:max-w-md mb-3 sm:mb-0">
            <input
              ...
              className="block w-full sm:max-w-md rounded-md border-0 px-4 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm/6"
            />
          </div>
          <div>
