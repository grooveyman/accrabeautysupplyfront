import { Home, Details, List, Search, NotFound, ShoppingCart, PasswordReset} from "../pages";
...
let PageComponents = [
    ...
    {name: "Passwordreset", path: "/reset-password", element: <PasswordReset />, id:11},
    {name: "NotFound", path: "*", element: <NotFound />, id:12}
